...
object AvatarCatalog {
    ...
    private val definitions = listOf(
        ...
        // Temporary visual integration test: Maya with the real fox-ear accessory attached.
        AvatarDefinition("maya_fox_ears_test", "Maya con Orejitas — Prueba", Gender.FEMALE, "models/avatars/maya_with_fox_ears_test.glb", SourceStatus.CATALOG_ENTRY_PENDING_MODEL, "female-1", idleAnimationName = "CharacterArmature|Idle")
    )
