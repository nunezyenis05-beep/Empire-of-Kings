...
object EquipmentCatalog {
    private val entries = listOf(
        ...
        EquipmentDefinition("ref_weapon_mythic_01", "Arma", "Cañón Castillo Carmesí"),
        EquipmentDefinition("ref_weapon_mythic_02", "Arma", "Rifle Cuervo Azul"),
        EquipmentDefinition("ref_weapon_mythic_03", "Arma", "Revólver Ojo de Dragón"),
        EquipmentDefinition("ref_weapon_mythic_04", "Arma", "Pistola Dorada Draconica"),
        EquipmentDefinition("ref_weapon_mythic_05", "Arma", "Pistola Rosa Draconica"),
        EquipmentDefinition("ref_weapon_mythic_06", "Arma", "Rifle Águila Carmesí"),
        EquipmentDefinition("ref_weapon_mythic_07", "Arma", "Rifle Dragón Dorado"),
        EquipmentDefinition("ref_weapon_mythic_08", "Arma", "Rifle Cuervo Fantasma"),
        EquipmentDefinition("ref_weapon_mythic_09", "Arma", "Rifle Cráneo Tóxico"),
        EquipmentDefinition("ref_weapon_mythic_10", "Arma", "SMG Hidra Tricéfala"),
        EquipmentDefinition("ref_weapon_mythic_11", "Arma", "Escopeta Kraken"),
        EquipmentDefinition("ref_weapon_mythic_12", "Arma", "SMG Dragón Esmeralda"),
        EquipmentDefinition("ref_weapon_mythic_13", "Arma", "SMG Espinas de Fuego"),
        EquipmentDefinition("ref_weapon_mythic_14", "Arma", "Lanza de Cristal Azul"),
        EquipmentDefinition("ref_weapon_mythic_15", "Arma", "Espada Fuego-Hielo"),
        EquipmentDefinition("ref_weapon_mythic_16", "Arma", "Tridente Carmesí"),
        EquipmentDefinition("ref_weapon_mythic_17", "Arma", "Espada Fénix Carmesí"),
        EquipmentDefinition("ref_weapon_mythic_18", "Arma", "Cetro Llameante"),
        EquipmentDefinition("ref_weapon_mythic_19", "Arma", "Maza Plateada Ardiente"),
        EquipmentDefinition("ref_weapon_mythic_20", "Arma", "Pistola Dorada Ornamental"),
        EquipmentDefinition("ref_weapon_mythic_21", "Arma", "Pistola Púrpura Ornamental"),
        EquipmentDefinition("ref_weapon_mythic_22", "Arma", "Espada Alada Azul"),
        EquipmentDefinition("ref_weapon_mythic_23", "Arma", "Espada Real Azul-Dorada"),
        EquipmentDefinition("ref_weapon_mythic_24", "Arma", "Espada Alada Fuego-Noche"),
        EquipmentDefinition("ref_weapon_mythic_25", "Arma", "AK Dragón Azul (Free Fire)"),
        EquipmentDefinition("ref_weapon_mythic_26", "Arma", "Rifle Alado Espacial"),
        EquipmentDefinition("ref_weapon_mythic_27", "Arma", "Cañón Castillo Carmesí (var.)"),
        EquipmentDefinition("ref_weapon_mythic_28", "Arma", "Rifle Águila Cósmica"),
        EquipmentDefinition("ref_weapon_mythic_29", "Arma", "Cañón Castillo Dorado"),
    )
