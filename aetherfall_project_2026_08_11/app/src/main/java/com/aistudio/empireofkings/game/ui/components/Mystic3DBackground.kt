...
import com.aistudio.empireofkings.game.ui.theme.CyanMagic
import com.aistudio.empireofkings.game.ui.theme.GoldGlow
import com.aistudio.empireofkings.game.ui.theme.GoldPrimary
import com.aistudio.empireofkings.game.ui.theme.MysticPurple
...
fun Mystic3DBackground(
    ...
    Box(modifier = modifier.fillMaxSize().background(Color(0xFF080B14))) {
        // The cathedral artwork belongs to the lobby only. Other screens use
        // the compact blue/black panel language from the original references.
        if (showLobbyImage) {
            Image(
